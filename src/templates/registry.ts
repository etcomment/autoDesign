...
export const TEMPLATES: TemplateDefinition[] = [
  ...
  },
  {
    type: 'dashboard5',
    label: 'dashboard5',
    description: 'Dashboard 5 carte du monde avec 6 callouts alternés, pictogrammes, badges et histogrammes.',
    category: 'Dashboards',
    defaultData: {
      type: 'dashboard5',
      metrics: [
        { label: 'Your title', value: '01', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Your title', value: '02', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Your title', value: '03', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Your title', value: '04', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Your title', value: '05', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Your title', value: '06', description: 'MIGSO-PCUBED content and words to be added here as required' },
      ],
    },
  },
  {
    type: 'kpi1',
    label: 'kpi1',
    description: 'Dashboard 5 grands tachymètres / jauges demi-cercle (Leadership, Talent, Market, Strategy, Culture).',
    category: 'Dashboards',
    defaultData: {
      type: 'kpi1',
      metrics: [
        { label: 'Leadership', value: '25', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Talent', value: '50', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Market', value: '85', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Strategy', value: '35', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Culture', value: '65', description: 'MIGSO-PCUBED content and words to be added here as required' },
      ],
    },
  },
  {
    type: 'kpi2',
    label: 'kpi2',
    description: 'Dashboard 4 cadrans KPI : donut, jauges de comparaison, barres groupées et barres mensuelles.',
    category: 'Dashboards',
    defaultData: {
      type: 'kpi2',
      metrics: [
        ...
        { label: 'Last month', value: '50', category: 'Last month comparison', percent: '50%' },
        { label: 'This month', value: '75', category: 'Last month comparison', percent: '75%' },
      ],
    },
  },
  {
    type: 'kpi3',
    label: 'kpi3',
    description: 'Dashboard 4 quadrants : Opérations (jauge), Produits (barres empilées), Revenus (barres) et Fabrication (courbes).',
    category: 'Dashboards',
    defaultData: {
      type: 'kpi3',
      metrics: [
        { label: 'OPERATIONS', value: '50', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'ProductS', value: '16', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'REVENUE', value: '4.5', description: 'MIGSO-PCUBED content and words to be added here as required' },
        { label: 'Manufacturing', value: '4', description: 'MIGSO-PCUBED content and words to be added here as required' },
      ],
    },
  },
  {
