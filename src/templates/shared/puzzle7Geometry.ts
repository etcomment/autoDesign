    ...
    return [
      {
        index: 0,
        path: makePuzzle7PiecePath('tl', bounds),
        iconCenter: { x: cx - 130, y: cy - 130 },
        numCenter: { x: cx - 70, y: cy - 130 },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy - 85 },
        defaultDot: { x: 190, y: cy - 85 },
      ...
      },
      {
        ...
        iconCenter: { x: cx - 18, y: cy - 135 },
        numCenter: { x: cx + 18, y: cy - 135 },
        isStraight: true,
        cardDirection: 'top',
  ...
  if (n === 7) {
    return [
      ...
      },
      {
        ...
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: 145 },
        defaultDot: { x: 810, y: 145 },
        defaultCard: { x: 820, y: 110, width: 140, height: 70 },
      ...
      },
      {
        ...
        iconCenter: { x: cx + 135, y: cy - 18 },
        numCenter: { x: cx + 135, y: cy + 18 },
        isStraight: true,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
        defaultDot: { x: 810, y: cy },
      ...
      },
      {
        ...
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: 375 },
        defaultDot: { x: 810, y: 375 },
        defaultCard: { x: 820, y: 340, width: 140, height: 70 },
  ...
  return [
    {
      ...
      isStraight: false,
      cardDirection: 'left',
      lineStart: { x: bounds.Xout_L, y: 145 },
      defaultDot: { x: 190, y: 145 },
      defaultCard: { x: 40, y: 110, width: 140, height: 70 },
    ...
    },
    {
      ...
      isStraight: false,
      cardDirection: 'left',
      lineStart: { x: bounds.Xout_L, y: 375 },
      defaultDot: { x: 190, y: 375 },
      defaultCard: { x: 40, y: 340, width: 140, height: 70 },
