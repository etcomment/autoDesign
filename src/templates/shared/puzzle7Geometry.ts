...
export function computePuzzle7Layout(
    ...
    return [
      {
        ...
        path: makePuzzle7PiecePath('tl', bounds),
        center: cTL,
        iconCenter: { x: 375, y: 135 },
        numCenter: { x: 422, y: 135 },
        isStraight: false,
        isThreePieceSide: true,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy - Rmid },
        defaultDot: { x: 190, y: cy - Rmid },
        defaultCard: { x: 35, y: cy - Rmid - 40, width: 140, height: 80 },
      ...
      },
      {
        ...
        center: cTop,
        iconCenter: { x: 492, y: 135 },
        numCenter: { x: 532, y: 135 },
        isStraight: true,
        isThreePieceSide: true,
        cardDirection: 'top',
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('tr', bounds),
        center: cTR,
        iconCenter: { x: 625, y: 140 },
        numCenter: { x: 625, y: 210 },
        isStraight: false,
        isThreePieceSide: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy - Rmid },
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('br', bounds),
        center: cBR,
        numCenter: { x: 550, y: 385 },
        iconCenter: { x: 620, y: 385 },
        isStraight: false,
        isThreePieceSide: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy + Rmid },
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('bl', bounds),
        center: cBL,
        numCenter: { x: 375, y: 310 },
        iconCenter: { x: 375, y: 380 },
        isStraight: false,
        isThreePieceSide: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy + Rmid },
  ...
  if (n === 6) {
    ...
    return [
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('br', bounds),
        center: cBR,
        numCenter: { x: 578, y: 385 },
        iconCenter: { x: 625, y: 385 },
        isStraight: false,
        isThreePieceSide: true,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy + Rmid },
      ...
      },
      {
        ...
        center: cBot,
        numCenter: { x: 468, y: 385 },
        iconCenter: { x: 508, y: 385 },
        isStraight: true,
        isThreePieceSide: true,
  ...
  if (n === 7) {
    ...
    return [
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('tr', bounds),
        center: cTR,
        iconCenter: { x: 625, y: 135 },
        numCenter: { x: 625, y: 182 },
        isStraight: false,
        isThreePieceSide: true,
        cardDirection: 'right',
      ...
      },
      {
        ...
        center: cRight,
        iconCenter: { x: 625, y: 252 },
        numCenter: { x: 625, y: 292 },
        isStraight: true,
        isThreePieceSide: true,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
  ...
  return [
    ...
    },
    {
      ...
      path: makePuzzle7PiecePath('bl', bounds),
      center: cBL,
      numCenter: { x: 375, y: 338 },
      iconCenter: { x: 375, y: 385 },
      isStraight: false,
      isThreePieceSide: true,
      cardDirection: 'left',
    ...
    },
    {
      ...
      center: cLeft,
      numCenter: { x: 375, y: 228 },
      iconCenter: { x: 375, y: 268 },
      isStraight: true,
      isThreePieceSide: true,
      cardDirection: 'left',
      lineStart: { x: bounds.Xout_L, y: cy },
