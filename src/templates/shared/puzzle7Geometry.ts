...
export function computePuzzle7Layout(
    ...
    return [
      {
        ...
        center: centerL,
        iconCenter: { x: centerL.x, y: centerL.y + 15 },
        numCenter: { x: centerL.x, y: centerL.y - 15 },
        isStraight: false,
        cardDirection: 'left',
      ...
      },
      {
        ...
        center: centerR,
        iconCenter: { x: centerR.x, y: centerR.y + 15 },
        numCenter: { x: centerR.x, y: centerR.y - 15 },
        isStraight: false,
        cardDirection: 'right',
    ...
    return [
      {
        ...
        center: c0,
        iconCenter: { x: c0.x, y: c0.y + 15 },
        numCenter: { x: c0.x, y: c0.y - 15 },
        isStraight: false,
        cardDirection: 'left',
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('half_right', bounds),
        center: c1,
        iconCenter: { x: c1.x, y: c1.y + 15 },
        numCenter: { x: c1.x, y: c1.y - 15 },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
        defaultDot: { x: 810, y: cy },
      ...
      },
      {
        ...
        center: c2,
        iconCenter: { x: c2.x, y: c2.y + 15 },
        numCenter: { x: c2.x, y: c2.y - 15 },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy + Rmid },
        defaultDot: { x: 190, y: cy + Rmid },
    ...
    return [
      {
        ...
        path: makePuzzle7PiecePath('tl', bounds),
        center: cTL,
        iconCenter: { x: cTL.x, y: cTL.y + 15 },
        numCenter: { x: cTL.x, y: cTL.y - 15 },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy - Rmid },
        defaultDot: { x: 190, y: cy - Rmid },
      ...
      },
      {
        ...
        center: cTR,
        iconCenter: { x: cTR.x, y: cTR.y + 15 },
        numCenter: { x: cTR.x, y: cTR.y - 15 },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy - Rmid },
        defaultDot: { x: 810, y: cy - Rmid },
        defaultCard: { x: 825, y: cy - Rmid - 40, width: 140, height: 80 },
        bbox: { x: bounds.Yout_T, y: bounds.Yout_T, width: Rout, height: Rout + tabProtrusion },
      },
      {
        index: 2,
        path: makePuzzle7PiecePath('br', bounds),
        center: cBR,
        iconCenter: { x: cBR.x, y: cBR.y + 15 },
        numCenter: { x: cBR.x, y: cBR.y - 15 },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy + Rmid },
        defaultDot: { x: 810, y: cy + Rmid },
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('bl', bounds),
        center: cBL,
        iconCenter: { x: cBL.x, y: cBL.y + 15 },
        numCenter: { x: cBL.x, y: cBL.y - 15 },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy + Rmid },
        defaultDot: { x: 190, y: cy + Rmid },
  ...
  if (n === 5) {
    ...
    return [
      ...
      },
      {
        ...
        center: cTop,
        iconCenter: { x: cTop.x, y: cTop.y + 15 },
        numCenter: { x: cTop.x, y: cTop.y - 15 },
        isStraight: true,
        cardDirection: 'top',
  ...
  if (n === 6) {
    ...
    return [
      ...
      },
      {
        ...
        center: cBot,
        iconCenter: { x: cBot.x, y: cBot.y + 15 },
        numCenter: { x: cBot.x, y: cBot.y - 15 },
        isStraight: true,
  ...
  if (n === 7) {
    ...
    return [
      ...
      },
      {
        ...
        center: cRight,
        iconCenter: { x: cRight.x, y: cRight.y + 15 },
        numCenter: { x: cRight.x, y: cRight.y - 15 },
        isStraight: true,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
        defaultDot: { x: 810, y: cy },
  ...
  return [
    ...
    },
    {
      ...
      center: cLeft,
      iconCenter: { x: cLeft.x, y: cLeft.y + 15 },
      numCenter: { x: cLeft.x, y: cLeft.y - 15 },
      isStraight: true,
      cardDirection: 'left',
      lineStart: { x: bounds.Xout_L, y: cy },
      defaultDot: { x: 190, y: cy },
