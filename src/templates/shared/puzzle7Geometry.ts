...
export function computePuzzle7Layout(
    ...
    return [
      {
        ...
        path: makePuzzle7PiecePath('tl', bounds),
        center: cTL,
        iconCenter: { x: cTL.x - 22, y: cTL.y },
        numCenter: { x: cTL.x + 24, y: cTL.y },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy - Rmid },
        defaultDot: { x: 190, y: cy - Rmid },
      ...
      },
      {
        ...
        center: cTop,
        iconCenter: { x: cTop.x - 22, y: cTop.y },
        numCenter: { x: cTop.x + 24, y: cTop.y },
        isStraight: true,
        cardDirection: 'top',
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('tr', bounds),
        center: cTR,
        iconCenter: { x: cTR.x, y: cTR.y - 22 },
        numCenter: { x: cTR.x, y: cTR.y + 24 },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy - Rmid },
        defaultDot: { x: 810, y: cy - Rmid },
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('br', bounds),
        center: cBR,
        numCenter: { x: cBR.x - 24, y: cBR.y },
        iconCenter: { x: cBR.x + 22, y: cBR.y },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy + Rmid },
        defaultDot: { x: 810, y: cy + Rmid },
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('bl', bounds),
        center: cBL,
        numCenter: { x: cBL.x, y: cBL.y - 24 },
        iconCenter: { x: cBL.x, y: cBL.y + 22 },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy + Rmid },
        defaultDot: { x: 190, y: cy + Rmid },
  ...
  if (n === 6) {
    ...
    return [
      ...
      },
      {
        ...
        center: cBot,
        numCenter: { x: cBot.x - 24, y: cBot.y },
        iconCenter: { x: cBot.x + 22, y: cBot.y },
        isStraight: true,
  ...
  if (n === 7) {
    ...
    return [
      ...
      },
      {
        ...
        center: cRight,
        iconCenter: { x: cRight.x, y: cRight.y - 22 },
        numCenter: { x: cRight.x, y: cRight.y + 24 },
        isStraight: true,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
        defaultDot: { x: 810, y: cy },
  ...
  return [
    ...
    },
    {
      ...
      center: cLeft,
      numCenter: { x: cLeft.x, y: cLeft.y - 24 },
      iconCenter: { x: cLeft.x, y: cLeft.y + 22 },
      isStraight: true,
      cardDirection: 'left',
      lineStart: { x: bounds.Xout_L, y: cy },
      defaultDot: { x: 190, y: cy },
