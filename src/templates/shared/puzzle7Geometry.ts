...
export function computePuzzle7Layout(
    ...
    return [
      {
        ...
        center: centerL,
        iconCenter: { x: centerL.x - 20, y: centerL.y },
        numCenter: { x: centerL.x + 20, y: centerL.y },
        isStraight: false,
        cardDirection: 'left',
      ...
      },
      {
        ...
        center: centerR,
        iconCenter: { x: centerR.x - 20, y: centerR.y },
        numCenter: { x: centerR.x + 20, y: centerR.y },
        isStraight: false,
        cardDirection: 'right',
  ...
  if (n === 3) {
    ...
    return [
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('half_right', bounds),
        center: c1,
        iconCenter: { x: c1.x - 17, y: c1.y },
        numCenter: { x: c1.x + 17, y: c1.y },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
        defaultDot: { x: 810, y: cy },
  ...
  if (n === 5) {
    ...
    return [
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('tr', bounds),
        center: cTR,
        iconCenter: { x: cTR.x - 17, y: cTR.y },
        numCenter: { x: cTR.x + 17, y: cTR.y },
        isStraight: false,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy - Rmid },
        defaultDot: { x: 810, y: cy - Rmid },
      ...
      },
      {
        ...
        path: makePuzzle7PiecePath('bl', bounds),
        center: cBL,
        iconCenter: { x: cBL.x - 17, y: cBL.y },
        numCenter: { x: cBL.x + 17, y: cBL.y },
        isStraight: false,
        cardDirection: 'left',
        lineStart: { x: bounds.Xout_L, y: cy + Rmid },
        defaultDot: { x: 190, y: cy + Rmid },
  ...
  if (n === 7) {
    ...
    return [
      ...
      },
      {
        ...
        center: cRight,
        iconCenter: { x: cRight.x - 17, y: cRight.y },
        numCenter: { x: cRight.x + 17, y: cRight.y },
        isStraight: true,
        cardDirection: 'right',
        lineStart: { x: bounds.Xout_R, y: cy },
        defaultDot: { x: 810, y: cy },
  ...
  return [
    ...
    },
    {
      ...
      center: cLeft,
      iconCenter: { x: cLeft.x - 17, y: cLeft.y },
      numCenter: { x: cLeft.x + 17, y: cLeft.y },
      isStraight: true,
      cardDirection: 'left',
      lineStart: { x: bounds.Xout_L, y: cy },
      defaultDot: { x: 190, y: cy },
