...
import type { Comparison8Data } from '../types'
...
export function Comparison8Template({ data }: { data: Comparison8Data }): ReactElement {
  ...
  const { leftTitle = 'Plan A', rightTitle = 'Plan B', leftItems = [], rightItems = [] } = data || {}
  const W = 800
  const colW = 280
  const colGap = 40
