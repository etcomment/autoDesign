...
3. **Attributs Numériques & Temporels** :
   ...
   - Icônes Lucide : `icon:"<nom-icone>"` (ex: `icon:"target"`, `icon:"check"`, `icon:"plane"`).
...
@roadmap "Roadmap Stratégique 2026"
  start "DÉBUT"
  finish "LIVRAISON"
  milestone "Alpha Release" "Tests internes" val:"STEP 1" date:2024 icon:"lightbulb" #3b82f6
  milestone "Beta Launch" "Accès anticipé" val:"STEP 2" date:2025 icon:"people" #8b5cf6
  milestone "GA Release" "Disponibilité générale" val:"STEP 3" date:2026 icon:"plane" #10b981
```
...
@business "Analyse d'Affaires Globale"
  center "Vision 2026"
  node "Part de Marché" "Acquisition clients" val:"£2.5M" pct:"75%" icon:"arrowUp" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  node "R&D Innovation" "Nouveaux brevets" val:"€1.2M" pct:"50%" icon:"gear" #8b5cf6
  node "Expansion" "Ouverture filiales" val:"$800K" pct:"35%" icon:"mapPin" #10b981
```
...
@process "Cycle de Développement Produit"
  step "Conception" "Cahier des charges et spécifications" icon:"clipboard" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  step "Développement" "Sprints de réalisation" icon:"code" #8b5cf6
  step "Recette QA" "Validation des tests automatisés" icon:"check" #10b981
  step "Déploiement" "Mise en production progressive" icon:"plane" #f59e0b
```
...
@strategy "Piliers de Croissance Stratégique"
  block "01" "Excellence Opérationnelle" "Optimisation continue des processus" icon:"shield" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  block "02" "Innovation Disruptive" "Investissements R&D et IA" icon:"lightbulb" #8b5cf6
  block "03" "Expansion Internationale" "Conquête des marchés asiatiques" icon:"globe" #10b981
  block "04" "Satisfaction Client" "Accompagnement et support dédié" icon:"star" #ec4899
```
...
@puzzle "Composants de l'Écosystème"
  piece "Stratégie" "Alignement de la vision" val:"100%" icon:"target" #2c2b64
    style fill #2c2b64 fontColor #ffffff
  piece "Exécution" "Mise en œuvre des projets" val:"85%" icon:"gear" #3366cc
  piece "Mesure" "Suivi des KPIs" val:"90%" icon:"barChart" #ff5338
  piece "Optimisation" "Amélioration continue" val:"70%" icon:"gear" #f2cb13
```
...
@funnel "Tunnel de Conversion Marketing"
  level "Visiteurs Unique" 10000 val:"10,000" pct:"100%" icon:"people" #2c2b64
    style fill #2c2b64 fontColor #ffffff
  level "Leads Qualifiés" 2500 val:"2,500" pct:"25%" icon:"user" #3366cc
...
@dashboard "Tableau de Bord Exécutif"
  metric "ARR" "£4.2M" "+18%" icon:"dollar" #10b981
    style fill #10b981 fontColor #ffffff
  metric "Taux de Retention" "94.2%" "+2.1%" icon:"people" #3b82f6
  metric "NPS Client" "+68" "+5 pts" icon:"star" #8b5cf6
  metric "Churn Mensuel" "0.8%" "-0.2%" icon:"arrowDown" #ec4899
```
...
@table "Matrice Comparative des Offres"
  ...
  row "Support 24/7" "Email" "Prioritaire" "Dédié & Téléphone" icon:"chat" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  row "Stockage Cloud" "10 GB" "500 GB" "Illimité" icon:"database" #8b5cf6
  row "Garantie SLA" "99.0%" "99.9%" "99.99%" icon:"shield" #10b981
```
...
@agenda "Planning de la Journée Séminaire"
  item "09:00" "Accueil & Café" "Discours d'ouverture et présentation" icon:"package" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  item "10:30" "Atelier Stratégie" "Session de travail en équipes" icon:"people" #8b5cf6
  item "14:00" "Keynote Innovation" "Intervention des experts invités" icon:"award" #10b981
  item "16:30" "Clôture & Cocktail" "Networking et bilan" icon:"waterDrop" #f59e0b
```
...
@comparison "Comparatif d'Architecture Tech"
  left "Option A: Monolithe" "Architecture classique centralisée" icon:"package" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  right "Option B: Microservices" "Distribution résiliente et scalable" icon:"package" #10b981
    style fill #10b981 fontColor #ffffff
```
...
@brain "Carte Mentale d'Innovation"
  center "Projet Alpha"
  node "Intelligence Artificielle" "Modèles prédictifs et LLM" pct:"80%" icon:"gear" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  node "Expérience Client" "Personnalisation du parcours" pct:"95%" icon:"user" #8b5cf6
  node "Sécurité & Données" "Chiffrement et conformité RGPD" pct:"100%" icon:"key" #10b981
```
...
@decision "Arbre de Décision Qualité"
  ...
  yes "Faible" -> "Approbation automatique" icon:"check" #10b981
  no "Élevé" -> "Revue Comité" icon:"flag" #ef4444
  leaf "Revue Comité" -> "Validation Direction" icon:"shield" #f59e0b
...
@goals "Objectifs Stratégiques Q3-Q4"
  metric "Chiffre d'Affaires" "Target: £5.0M" val:"£4.2M" pct:"84%" icon:"target" #10b981
    style fill #10b981 fontColor #ffffff
  metric "Satisfaction Client" "Target: 95%" val:"92%" pct:"92%" icon:"star" #3b82f6
  metric "Nouveaux Utilisateurs" "Target: 50K" val:"41K" pct:"82%" icon:"user" #8b5cf6
```
...
@manufacturing "Ligne de Fabrication Industrielle"
  station "Approvisionnement" "Réception des matières premières" icon:"truck" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  station "Assemblage" "Montage automatique des composants" icon:"gear" #8b5cf6
  station "Contrôle Qualité" "Inspection optique et métrologie" icon:"target" #10b981
...
@valueChain "Chaîne de Valeur Entreprise"
  primary "Logistique Interne" "Stockage et gestion" icon:"folder" #1a2249
  primary "Production" "Transformation" icon:"gear" #2b63d9
...
@iceberg "Structure des Coûts Cachés"
  section "Coûts Visibles (Surface)" "Licences et matériel direct" val:"20%" icon:"globe" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  section "Maintenance & Support" "Mises à jour et assistance" val:"35%" icon:"gear" #10b981
  section "Dette Technique (Immergé)" "Refactorisation et sécurité" val:"45%" icon:"flag" #ef4444
```
...
@circle "Cycle d'Amélioration Continue (PDCA)"
  center "Qualité"
  segment "Planifier (Plan)" "Définir les objectifs et processus" pct:"25%" icon:"target" #3b82f6
    style fill #3b82f6 fontColor #ffffff
  segment "Déployer (Do)" "Exécuter les plans d'action" pct:"50%" icon:"arrowUp" #8b5cf6
  segment "Contrôler (Check)" "Mesurer les résultats obtenus" pct:"75%" icon:"check" #10b981
  segment "Agir (Act)" "Corriger et standardiser" pct:"100%" icon:"recycle" #f59e0b
```
